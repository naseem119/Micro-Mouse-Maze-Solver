...
// Constants
// 8x8 maze, with 25x25 cells 
#define MAZE_DIMENSION 8
#define CELL_DIMENSION 25
#define NMOTORS 2
...
// perfect run forward speed = 30, left right = 20, 180 = 25

// speeds
#define FORWARD_SPEED 35
#define TURN_LEFT_RIGHT 25
#define TURN_180 30

// waiting for next profile
#define WAITING_TIME 1.7
